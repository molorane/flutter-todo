...
mixin _$ReportsState {
  List<TodoDocument> get documents => throw _privateConstructorUsedError;
...
class _$_ReportsState extends _ReportsState {
  const _$_ReportsState({final List<TodoDocument> documents = const []})
  ...
  @override
  String toString() {
    return 'ReportsState(documents: $documents)';
  }
