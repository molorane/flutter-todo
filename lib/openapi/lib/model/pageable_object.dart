...
class PageableObject {
  ...
  @override
  String toString() =>
      'PageableObject[offset=$offset, sort=$sort, paged=$paged, unpaged=$unpaged, pageNumber=$pageNumber, pageSize=$pageSize]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PageableObject[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PageableObject[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PageableObject>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PageableObject>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PageableObject.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
