        ...
        children: [
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                Text("**** **** **** $number",style: TextStyle(fontFamily: "Cerebri Sans",color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                SizedBox(height: 20,),
                Text("Balance",style: TextStyle(color: Colors.white,fontSize: 17),),
                SizedBox(height: 2,),
                Text("\$$amount",style: TextStyle(fontFamily: "Cerebri Sans",color: Colors.white,fontSize: 25,fontWeight: FontWeight.w800),),
              ],
            ),
          ),
        ],
