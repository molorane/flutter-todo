                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 10,),
                      Text("Mothusi Molorane",style: TextStyle(fontFamily: 'Cerebri Sans',fontWeight: FontWeight.w700,fontSize: 17),),
                      //SizedBox(height: 2,),
                      Text("0639211830",style: TextStyle(fontFamily: 'Cerebri Sans',fontStyle: FontStyle.normal),),
                    ],
                  ),
                ),
                SizedBox(height: 22,),
